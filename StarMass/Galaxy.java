...
public class Galaxy {
    ...
    public static void main(String[] args) {
        ...
        Star betelgeuse = new Star("Betelgeuse", 128.23, -12.82, 32.328, 1289, 538595);
        Star altair = new Star("Altair", 43894.34, -324.43, 9438.23, 123, 137273);
        Star bellatrix = new Star("Bellatrix", 584.34, 2103.32, -102.43, 413, 5483724);
